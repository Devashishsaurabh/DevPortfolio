    ...
    <div className="footer">
      ...
      <div className="f-content">
        ...
        <div className="f-icons">
          <a href="https://github.com/Devashishsaurabh" target="_blank"><Linked color="#0077b5 " size={"3rem"} /></a>
          <a href="https://www.instagram.com/devashish_saurabh_official" target="_blank"><Insta color="#cb3e7a" size={"3rem"} /></a>
          <a href="https://www.linkedin.com/in/dev-ashish-saurabh/" target="_blank"><Gitub color="Black" size={"3rem"} /></a>
